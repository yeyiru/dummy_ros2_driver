...
import threading
import traceback
import dummy_cli_tool.fibre.protocol
import dummy_cli_tool.fibre.utils
import dummy_cli_tool.fibre.remote_object
from dummy_cli_tool.fibre.utils import Event, Logger
from dummy_cli_tool.fibre.protocol import ChannelBrokenException, TimeoutError
import dummy_cli_tool.fibre as fibre
# Load all installed transport layers

channel_types = {}

try:
    import dummy_cli_tool.fibre.usbbulk_transport
    channel_types['usb'] = fibre.usbbulk_transport.discover_channels
except ImportError:
    pass

try:
    import dummy_cli_tool.fibre.serial_transport
    channel_types['serial'] = fibre.serial_transport.discover_channels
except ImportError:
    pass

try:
    import dummy_cli_tool.fibre.tcp_transport
    channel_types['tcp'] = fibre.tcp_transport.discover_channels
except ImportError:
    pass

try:
    import dummy_cli_tool.fibre.udp_transport
